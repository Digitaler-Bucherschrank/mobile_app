...
""";
String elucidationTitle = "Aufklärung in Datenverwendung gem. Art. 13 DSGVO";
String elucidation = """
...
Interaktion mit Büchern
Beim Spenden, Ausleihen und Zurückgeben, sowie beim Löschen von Büchern wird eine Refferenz zum interagierenden Nutzer gespeichert. Diese Maßnahme soll Missbrauch vorbeugen und macht durch Vandalismus entstandene Schäden reparierbar .
...
Google Maps
Unser Angebot nutzt zur Darstellung von Karten teilweise die Google Maps API, einen Kartendienst von Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA.
...
Die Rechtsgrundlage dieser Datenverarbeitung ist Art. 6 Abs. 1 b) DSGVO, da die IP-Adresse benötigt wird, um dir die Inhalte für die Karten liefern zu können. Bei dieser Verarbeitung erfolgt unsere Zusammenarbeit mit Google auf Grundlage eines Vertrags über die gemeinsame Verantwortlichkeit gemäß Art. 26 DSGVO, der hier abgerufen werden kann: https://privacy.google.com/intl/de/businesses/mapscontrollerterms/

Weitere Informationen zur Datenverarbeitung durch Google findest du in den Datenschutzrichtlinien von Google unter https://www.google.com/policies/privacy/.

Google Fonts
Bei der Nutzung von Google Maps wird automatisch eine Google Font (Schriftart) des Anbieters Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland, geladen. Dies kann nicht unterbunden werden. Die Datenschutzerklärung von Google findet sich hier: https://www.google.com/policies/privacy/  .
...
5.) jede datenschutzrechtliche Einwilligung mit Wirkung für die Zukunft zu widerrufen .
